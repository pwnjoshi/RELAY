            ...
            <div className="bg-white dark:bg-[#10223A] border border-[#E4E8E7] dark:border-[#20324A] rounded-2xl p-6 shadow-subtle space-y-6">
              <div className="flex items-center justify-between flex-wrap gap-3 pb-4 border-b border-[#E4E8E7] dark:border-[#20324A]">
                ...
                <span className="text-[10px] font-mono font-bold px-2.5 py-1 rounded-full bg-[#1B9A9C]/10 text-[#1B9A9C] border border-[#1B9A9C]/30">
                  Powered by Nebius DeepSeek-V4-Flash
                </span>
              </div>
                ...
                <div className="space-y-2 p-4 rounded-xl bg-[#FAFAF8] dark:bg-[#081426] border border-[#E4E8E7] dark:border-[#20324A]">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-[10px] font-mono font-bold text-[#1B9A9C] hover:underline"
                    >
                      {showPromptPreview ? "Hide Neural Prompt" : "Inspect Neural Prompt"}
                    </button>
                  </div>
                  <input
                    type="text"
                    ...
                    className="w-full bg-white dark:bg-[#10223A] border border-[#E4E8E7] dark:border-[#20324A] rounded-lg px-3 py-2 text-xs text-[#0B1930] dark:text-[#F8FAFC] outline-none focus:border-[#1B9A9C]"
                  />
                </div>
              </div>

              {/* Neural System Prompt Inspector */}
              {showPromptPreview && (
                <div className="p-4 rounded-xl bg-[#0B1930] text-emerald-300 font-mono text-[11px] space-y-2 animate-fade-in border border-[#1B9A9C]/30">
                  <div className="flex items-center justify-between text-white font-bold border-b border-[#20324A] pb-2">
                    <span>DeepSeek-V4 Dynamic System Directive</span>
                    <span className="text-[10px] text-[#1B9A9C]">Tone: {persona.toUpperCase()}</span>
                  </div>
                  <pre className="whitespace-pre-wrap leading-relaxed">
{`You are Sarah, an autonomous voice operations agent operating in ${persona.toUpperCase()} mode.
- Pacing: <20 words per utterance, natural conversational cadence.
- Opening Greeting: "${customGreeting}"
- Grounding: Factually grounded in real-time scraped website RAG knowledge snippets.
- Latency target: ${latencyTier}ms.`}
                  </pre>
                </div>
              )}
            </div>
