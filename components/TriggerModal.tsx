              ...
              <div className="space-y-2 pt-1 text-[11px]">
                ...
                <div className={`flex items-center gap-2.5 transition-all ${dispatchStep >= 2 ? "text-[#F8FAFC]" : "text-[#627284]"}`}>
                  ...
                  <span className={dispatchStep === 2 ? "font-bold text-[#32C4BE]" : ""}>
                    Synthesizing Neural Multilingual Voice ({SUPPORTED_LANGUAGES.find(l => l.code === selectedLanguage)?.label || "Multilingual"})
                  </span>
                </div>
              ...
              {resultMessage.ok ? (
                <div className="space-y-2">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-[#10223A] border border-[#20324A] text-[11px]">
                    ...
                    {(liveCallStatus === "in-progress" || liveCallStatus === "in_progress" || liveCallStatus === "active" || liveCallStatus === "answered" || liveCallStatus === "running") ? (
                    ...
                    ) : (liveCallStatus === "ringing" || liveCallStatus === "dialing" || liveCallStatus === "dispatched" || liveCallStatus === "created") ? (
